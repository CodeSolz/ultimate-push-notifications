 ...
 * Description:       Push notification solutions for desktop and mobiles. This plugin send push notification
 * Version:           1.0.0
 * Author:            CodeSolz
...
if (!class_exists('Ultimate_Push_Notifications')) {
    ...
    class Ultimate_Push_Notifications {
        ...
        public static function upn_init_function(){
            ...
            // $Cs_Notices = self::$namespace . "\admin\notices\UpnNotices";
            // $Cs_Notices::activated();
